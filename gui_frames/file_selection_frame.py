...
class FileSelectionFrame(CTkFrame):
    ...
    def build_ui(self):
        ...
        self.vcf_success_label = CTkLabel(content_frame, text="", font=("Segoe UI", 16, "bold"), text_color="#008000")
        ...
        self.trait_success_label = CTkLabel(content_frame, text="", font=("Segoe UI", 16, "bold"), text_color="#008000")
        ...
        self.next_btn = CTkButton(nav_frame, text="Run Full QTL Analysis", font=("Segoe UI", 16, "bold"),
    ...
    def update_next_button_state(self):
        if self.vcf_file_path and self.trait_file_path:
            self.next_btn.configure(state="normal", fg_color="#008000", hover_color="#006400", text_color="#ffffff")
        else:
            self.next_btn.configure(state="disabled", fg_color="#cccccc", hover_color="#bbbbbb", text_color="#222222")
