...
def open_format_window(current_style, parent=None):
    ...
    title_label = CTkLabel(page_frame, text="", font=("Segoe UI", 18, "bold"), anchor="center")
    title_label.pack(pady=(10, 5))

    text_area = CTkTextbox(page_frame, wrap="word", font=("Segoe UI", 14))
    ...
    back_btn = CTkButton(nav_frame, text="←", width=50, font=("Segoe UI", 16, "bold"),
                         command=lambda: show_page(0), **white_button_style)
    next_btn = CTkButton(nav_frame, text="→", width=50, font=("Segoe UI", 16, "bold"),
                         command=lambda: show_page(1), **white_button_style)
    close_btn = CTkButton(nav_frame, text="Close", font=("Segoe UI", 14, "bold"), width=120,
